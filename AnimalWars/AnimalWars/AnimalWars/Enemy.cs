...
namespace AnimalWars
{
    class Enemy: Sprite
    {
        ...
        public Enemy(Texture2D image, Point currentFrame, int timeSinceLastFrame, Vector2 position, float velocity,
                                    ...
                                    float blood, float rateImage, bool live, int level, SpriteManager spriteManager, Texture2D bloddImage, int tamNhin)
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (playerIndex != -1)
            {
                ...
                //Vector2 playerPosition = spriteManager.GetPositionList[0];
