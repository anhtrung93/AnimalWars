...
{
    class BugBuster:Entities.UserControlledSprite
    {
        PlayingScreen spriteManager;
        public BugBuster(Texture2D image, Point currentFrame, int timeSinceLastFrame, Vector2 position, float velocity,
